...
Devise.setup do |config|
  ...
  config.mailer_sender = 'mtgdraft@example.com'
  ...
  # their account can't be confirmed with the token any more. Default is nil,
  # meaning there is no restriction on how long a user can take before
  ...
  # :failed_attempts Locks account after number of failed attempts to sign in.
